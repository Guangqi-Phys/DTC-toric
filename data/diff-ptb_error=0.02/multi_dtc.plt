...
set title "ptb = 0.02" font ",18"


plot 'nodecoder_ptb=0.020000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.020000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.020000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.020000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

unset key
unset ylabel

set title "ptb = 0.04" font ",18"


plot 'nodecoder_ptb=0.040000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.040000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.040000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.040000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

set title "ptb = 0.06" font ",18"


plot 'nodecoder_ptb=0.060000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.060000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.060000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.060000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

set xlabel "t/T" font ",18"
set ylabel "<Logical_{Z}>" font ",18"


set title "ptb = 0.08" font ",18"


plot 'nodecoder_ptb=0.080000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.080000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.080000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.080000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

unset ylabel
set title "ptb = 0.10" font ",18"


plot 'nodecoder_ptb=0.100000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.100000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.100000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.100000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

set title "ptb = 0.12" font ",18"


plot 'nodecoder_ptb=0.120000_ns=100_nt=200.dat' using 1:2 with lines ls 1 lw 2 t "without decoder",\
'nodecoder_ptb=0.120000_ns=100_nt=200.dat' using 1:3 with lines ls 1 lw 2 t "",\
'decoder_ptb=0.120000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "with decoder",\
'decoder_ptb=0.120000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\

# 'decoder_ptb=0.080000_ns=100_nt=200.dat' using 1:2 with lines ls 2 lw 2 t "0.05",\
# 'decoder_ptb=0.080000_ns=100_nt=200.dat' using 1:3 with lines ls 2 lw 2 t "",\
...
#
# plot 'data_decoder_thd=0.040000_ns=50_nt=1000.dat' using 1:2 with lines ls 1 lw 2 t "threshold=0.01",\
# 'data_decoder_thd=0.040000_ns=50_nt=1000.dat' using 1:3 with lines ls 1 lw 2 t "",\
